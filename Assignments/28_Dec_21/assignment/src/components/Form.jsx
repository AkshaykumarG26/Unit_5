...
export const Form = () => {
  ...
  const sortLH = () => {
    ...
    fetch(
      `http://localhost:3004/user?_sort=salary&_order=asc&_page=${page}&_limit=5`
    )
      .then((res) => res.json())
      .then((res) => {
  ...
  const sortHL = () => {
    ...
    fetch(
      `http://localhost:3004/user?_sort=salary&_order=desc&_page=${page}&_limit=5`
    )
      .then((res) => res.json())
      .then((res) => {
  ...
  const filterDepartment = (depart) => {
    ...
    fetch(
      `http://localhost:3004/user?department=${depart}&_page=${page}&_limit=5`
    )
      .then((res) => res.json())
      .then((res) => {
